// js/player/simple-artistic.js - Working Artistic Effects
const SimpleArtisticEffects = (function() {
    ...
    function updateCanvas() {
        ...
        canvas.width = Math.min(videoPlayer.videoWidth || rect.width, 800); // Limit size for performance
        canvas.height = Math.min(videoPlayer.videoHeight || rect.height, 600);
